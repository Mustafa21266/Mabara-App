...
class EditArticle extends Component {
  config = {
    ...
    imageUploadURL: `http://127.0.0.1:4000/api/v1/admin/article/images/upload/${
      store.getState().auth.user._id
    }`,
    // imageRemoveURL: `http://127.0.0.1:4000/api/v1/admin/article/images/delete/${store.getState().auth.user._id}`,
    ...
    events: {
      ...
      "image.removed": function ($img) {
        ...
        xhttp.open(
          "POST",
          `http://127.0.0.1:4000/api/v1/admin/article/images/delete/${
            store.getState().auth.user._id
          }`,
          true
        );
